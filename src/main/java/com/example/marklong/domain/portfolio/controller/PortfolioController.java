...
public class PortfolioController {
    ...
    public ResponseEntity<ApiResponse<Long>> create(
        ...
        return ResponseEntity.ok(ApiResponse.ok(portfolioService.create(authUser.userId(), request)));
    }
    ...
    public ResponseEntity<ApiResponse<List<PortfolioResponse>>> getMyPortfolios(
        ...
        return ResponseEntity.ok(ApiResponse.ok(portfolioService.getMyPortfolios(authUser.userId())));
    }
    ...
    public ResponseEntity<ApiResponse<PortfolioDetailResponse>> getOne(
        ...
        return ResponseEntity.ok(ApiResponse.ok(portfolioService.getOne(authUser.userId(), portfolioId)));
    }
    ...
    public ResponseEntity<ApiResponse<PortfolioResponse>> update(
        ...
        return ResponseEntity.ok(ApiResponse.ok(portfolioService.update(authUser.userId(), portfolioId, request)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        portfolioService.delete(authUser.userId(), portfolioId);
    ...
    public ResponseEntity<ApiResponse<PortfolioItemResponse>> allocate(
        ...
        return ResponseEntity.ok(ApiResponse.ok(portfolioService.allocate(authUser.userId(), portfolioId, request)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deallocate(
        ...
        portfolioService.deallocate(authUser.userId(), portfolioId, itemId);
        return ResponseEntity.ok(ApiResponse.ok(null));
    }
}
