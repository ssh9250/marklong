...
public class EventController {
    ...
    public ResponseEntity<ApiResponse<Long>> createUserEvent(
        ...
        return ResponseEntity.ok(ApiResponse.ok(eventService.createUserEvent(authUser.userId(), request)));
    }
    ...
    public ResponseEntity<ApiResponse<Long>> createAdminEvent(
        ...
        return ResponseEntity.ok(ApiResponse.ok(eventService.createAdminEvent(authUser.userId(), request)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> update(
        ...
        eventService.update(authUser.userId(), authUser.role(), eventId, request);
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        eventService.delete(authUser.userId(), authUser.role(), eventId);
        return ResponseEntity.ok(ApiResponse.ok(null));
    }
}
